    ...
    <Navbar className="[ footer ]">
      <Container className="[ footer-container ]">
        <Nav className="[ social-nav ]">
          ...
          >
            <img className="icon" src={Facebook} alt="Hargreaves Facebook Profile" />
          </a>
          <a
            className="[ social-link ]"
            href="https://www.instagram.com/heartbyhargreaves/"
          >
            <img className="icon" src={Instagram} alt="Hargreaves Instagram Profile" />
          </a>
        ...
        <Nav className="[ footer-nav ]">
          ...
          <a className="[ footer-link cta ]" href="https://streamlabs.com/templito/tip">
            Donate
          </a>
        </Nav>
      </Container>
